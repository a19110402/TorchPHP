...
<div class="tabbed">
  ...
  <section id="section1">
    ...
    <form method='POST' action="javascript:void(0);" data-action="{{ url('/fedex') }}" id="create-open-ship">
        ...
        Specify accountNumber
        Example: 510087020<br>
        </label>
  ...
  <section id="section5">
    <h3>Add Open shipment Packages</h3>
      @csrf
      <form method='POST' action="javascript:void(0);" data-action="{{ url('/fedex') }}" id="add-open-ship-packages">
        @csrf
        <label for="accountNumber_value">
          Specify accountNumber
          Example: 510087020<br>
        ...
        <label for="currency">
        This is the currency for example USD.<br>
        </label>
        <input placeholder="currency" type="text" name="currency" ><br><br>
            
        <label for="amount">
        This is the amount of the currency.<br>
        </label>
        <input placeholder="amount" type="text" name="amount" ><br><br>
...
@endsection
@section('scripts')
    <script type="module" src="{{ asset('js/fedex/openShip.js') }}"></script>
    <script type="module" src="{{ asset('js/fedex/requeringToken.js') }}"></script>
@endsection
