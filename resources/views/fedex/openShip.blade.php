...
<div class="tabbed">
    ...
    <form method='POST' action="javascript:void(0);" data-action="{{ url('/fedex') }}" id="create-open-ship">
        ...
        <input placeholder="value" type="text" name="accountNumber" ><br><br>
            ...
            <fieldset>
                ...
                <input placeholder="countryCode" type="text" name="recipient_countryCode" ><br><br>
  ...
  <section id="section2">
    ...
    <form method='POST' action="javascript:void(0);" data-action="{{ url('/fedex') }}" id="modify-open-ship">
            @csrf
            <form method='POST' action="javascript:void(0);" data-action="{{ url('/fedex') }}" id="create-open-ship">
        @csrf
        <label for="serviceType">                	
